...
def main():
    ...
    for mydate in mydatelist:
        command = "/home/lisag/git/GlobusArchiver/GlobusArchiver.py --archiveDateTimeString %s --config /home/lisag/git/cospa/convwx/Globus_Archiver_CONVWX_HOST.py | LogFilter -d %s -p Globus_Archiver.py_c27_24hr_rerun" % (mydate, log_dir)
        print(command)
