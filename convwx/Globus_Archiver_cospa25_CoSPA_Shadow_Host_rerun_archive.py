...
def main():
    ...
    for mydate in mydatelist:
        command = "/home/lisag/git/GlobusArchiver/GlobusArchiver.py --archiveDateTimeString %s --config /home/lisag/git/cospa/convwx/Globus_Archiver_cospa25_rtma.py | LogFilter -d %s -p Globus_Archiver.py_cospa20_rtma_rerun" % (mydate, log_dir)
        print(command)
