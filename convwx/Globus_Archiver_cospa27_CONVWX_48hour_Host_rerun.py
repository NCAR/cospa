...
def main():
    ...
    for mydate in mydatelist:
        command = "/home/lisag/git/GlobusArchiver/GlobusArchiver.py --archiveDateTimeString %s --config /home/lisag/git/cospa/convwx/Globus_Archiver_CONVWX_48Hour_Host.py | LogFilter -d %s -p Globus_Archiver.py_c27_48hr_rerun" % (mydate, log_dir)
        print(command)
