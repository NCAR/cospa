...
def main():
    ...
    for mydate in mydatelist:
        command = "/home/lisag/git/GlobusArchiver/GlobusArchiver.py --archiveDateTimeString %s --config /home/lisag/git/cospa/epoch_ops/Globus_Archiver_Epoch_Ops.py | LogFilter -d %s -p Globus_Archiver.py_c23_epoch_ops_rerun" % (mydate, log_dir)
        print(command)
